...
module gas_mod
  ...
  real(r8), public, parameter :: kb       = 1.380649e-23_r8      ! Boltzmann constant (J K-1)
  real(r8), public, parameter :: na       = 6.02214076e23_r8     ! Avogadro constant (mol-1)
  real(r8), public, parameter :: ru       = kb * na              ! Universal gas constant (J K-1 mol-1)
  real(r8), public, parameter :: amu      = 1.0_r8 / (1000 * na) ! Atomic mass unit (kg) ~ 1.6605390672e-27
