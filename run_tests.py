...
if len(args.cases) > 0:
	...
	run_case('gmcore_driver.exe', 'swm_cp.360x180')
	run_case('gmcore_driver.exe', 'swm_cm.720x360')
	run_case('gmcore_driver.exe', 'swm_rh.180x90')
	run_case('gmcore_driver.exe', 'swm_rh.360x180')
	run_case('gmcore_driver.exe', 'swm_mz.180x90')
	run_case('gmcore_driver.exe', 'swm_mz.360x180')
	run_case('gmcore_driver.exe', 'swm_jz.180x90')
	run_case('gmcore_driver.exe', 'swm_jz.360x180')
	run_case('gmcore_driver.exe', 'swm_vr.360x180')
